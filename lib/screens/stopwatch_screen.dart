  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<StopwatchProvider>(
      builder: (context, provider, _) {
        final stopwatches = selectedColor == null
            ? provider.sortedStopwatches
            : provider.sortedStopwatches
                .where(
                  (stopwatch) =>
                      stopwatch.color == selectedColor,
                )
                .toList();
        return Scaffold(
            ...
            child: Column(
              children: [
                ScreenHeader(
                  title: 'STOPWATCH',
                  subtitle:
                      '${stopwatches.where((s) => s.isRunning).length} running',
                  actions: [
                    ColorFilterButton(
